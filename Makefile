...
migrateup:
	migrate -path db/migration -database "postgresql://root:IzLSnVcVD8ysPhlrYGK5@simple-bank.cgyx1jnpifr0.us-west-1.rds.amazonaws.com:5432/simple-bank" -verbose up
